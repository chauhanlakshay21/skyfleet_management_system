...
public  class Cancel extends JFrame implements ActionListener{
    ...
    public Cancel(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("skyline_fleet_management/icons/cancel.jpg"));
      ...
      public void actionPerformed(ActionEvent ae) {
          ...
          String pnr = tfpnr.getText();
           ...
           try {
               ...
               String query = "insert into cancel1 values('"+pnr+"', '"+name+"', '"+cancelno+"', '"+Flightcode+"', '"+date+"')";
