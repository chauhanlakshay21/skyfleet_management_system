...
public  class BookFlight extends JFrame implements ActionListener{
    ...
    public BookFlight(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("skyline_fleet_management/icons/details.jpg"));
        ...
        bookflight.setBounds(150, 600, 150, 25);
          ...
          String dest = destination.getSelectedItem();
           ...
           try {
               ...
               conn.s.executeUpdate(query);
                ...
                JOptionPane.showMessageDialog(null, "Ticked book succesfully");
